...
type GateHook = (user: UserNullish, ability: string, ...args) => boolean | void;
type GateDefinition = (user: UserNullish, ...args) => boolean | void;
...
class Gate {
    ...
    setUser(user: object | Promise<UserNullish>) {
    ...
    #callBeforeCallbacks(user: UserNullish, ability: string, args) {
    ...
    #callAfterCallbacks(user: UserNullish, ability: string, args, result) {
